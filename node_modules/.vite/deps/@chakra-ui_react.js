...
var focusScope = (0, import_react63.createContext)(void 0);
...
var FocusLock = React7.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  ], !disabled && React7.createElement(SideCar, {
    id,
...
var useSafeLayoutEffect3 = isBrowser3 ? import_react70.useLayoutEffect : import_react70.useEffect;
...
function useEventListener2(event, handler, env, options) {
  ...
  (0, import_react77.useEffect)(() => {
    var _a8;
    const node3 = (_a8 = runIfFn3(env)) != null ? _a8 : document;
    if (!handler) {
      return;
    }
    node3.addEventListener(event, listener, options);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react124.useState)(true);
