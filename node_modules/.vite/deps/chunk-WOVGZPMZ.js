...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component3 !== import_react15.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
...
var color = {
  ...
  transform: (v) => {
    return isString(v) ? v : v.hasOwnProperty("red") ? rgba2.transform(v) : hsla.transform(v);
  }
};
...
//# sourceMappingURL=chunk-WOVGZPMZ.js.map
